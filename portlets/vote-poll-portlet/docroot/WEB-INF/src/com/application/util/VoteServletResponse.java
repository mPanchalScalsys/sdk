...
public class VoteServletResponse extends HttpServletResponseWrapper {

	public VoteServletResponse(HttpServletResponse response) {
		super(response);
	}
	...
	public ServletOutputStream getOutputStream() {
		...
		if (_servletOutputStream == null) {
			...
			_servletOutputStream = new VoteServletOutputStream(
